...
class ZP_RscListBox
{
	...
	class ListScrollBar: ZP_ScrollBar
	{
		color[] = {1,1,1,1};
		autoScrollEnabled = 1;
	};
...
class ZP_RscButtonInvisible: ZP_RscButton
{
	colorBackground[] = {0,0,0,0};
...
class ZP_RscCombo
{
	...
	class ComboScrollBar: ZP_ScrollBar
	{
		color[] = {1,1,1,1};
	};
};
